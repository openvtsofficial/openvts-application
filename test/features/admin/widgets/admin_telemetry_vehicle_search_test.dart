...
import 'package:open_vts/features/admin/screens/logs/widgets/admin_telemetry_logs_panel.dart';

void main() {
  testWidgets('Telemetry Vehicle searches source fields and selects ID', (
    tester,
  ) async {
      ...
      MaterialApp(
        home: Scaffold(
          body: StatefulBuilder(
            builder: (context, setState) => AdminTelemetryVehicleDropdown(
    ...
    final trigger = find.descendant(
      of: find.byType(AdminTelemetryVehicleDropdown),
