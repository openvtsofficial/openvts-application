...
class _SmtpSettingsSectionState extends ConsumerState<SmtpSettingsSection> {
  ...
  AdminSmtpType _type = AdminSmtpType.none;
  ...
  void _hydrate(AdminSmtpSettings? smtp) {
    if (smtp == null) return;
  ...
  Future<void> _save() async {
    ...
    final request = AdminSmtpSettings(
    ...
    if (ok) {
      ...
      if (mounted) {
        ...
        _hydrate(ref.read(adminSettingsControllerProvider).smtp);
      }
    } else {
